...
<div class="d-sm-flex align-items-center justify-content-end mb-4">
	...
	<a href="list-alternatif.php" class="btn btn-secondary btn-icon-split font-weight-bold" style="background-color:#393E46; color:white;"><span class="icon"><i class="fas fa-arrow-left"></i></span>
...
<form action="edit-alternatif.php?id=<?php echo $id_alternatif; ?>" method="post">
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-info text-dark"> Edit Data Alternatif</h6>
		</div>
		<?php
		if(!$id_alternatif) {
		?>
		...
		<div class="card-footer text-right">
            <button name="submit" value="submit" type="submit" class="btn btn-success font-weight-bold"><i class="fa fa-save"></i> Update</button>
            <button type="reset" class="btn btn-danger font-weight-bold"><i class="fa fa-sync-alt"></i> Reset</button>
        </div>
		<?php
		}
		}
