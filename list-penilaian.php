...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h5 class="m-0 font-weight-bold text-center text-dark"> Daftar Data Penilaian</h5>
    </div>
	
	<div class="card-body">
		<div class="table-responsive">
			<table class="table table-bordered font-weight-bold text-black table-secondary" id="dataTable" width="100%" cellspacing="0" style="color:black">
				<thead class="bg-info text-white">
					<tr align="center" style="background-color:#393E46;">
						<th width="5%">No</th>
						<th>Alternatif</th>
						<th width="15%">Aksi</th>
					</tr>
