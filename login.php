...
<html lang="en">
    <head>
        ...
        <title>Sistem Rekrutmen ARAS</title>
    ...
    <body class="" style="background-color:#222831;">
        ...
        <div class="container">
            ...
            <div class="row d-flex justify-content-center mt-5">				
                ...
                <a class="navbar-brand" style="font-weight: 900; color:#EEEEEE; font-size: 30px; margin-top:15vh;" href="login.php"> <i class="fas fa-solid fa-id-card rotate-n-19"></i>&nbsp; Sistem Rekrutmen ARAS</a>
            </div>
