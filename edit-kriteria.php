...
<div class="d-sm-flex align-items-center justify-content-end mb-4">
	...
	<a href="list-kriteria.php" class="btn btn-secondary btn-icon-split font-weight-bold" style="background-color:#393E46; color:white"><span class="icon"><i class="fas fa-arrow-left"></i></span>
...
<div class="card shadow mb-4 text-dark">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-dark"> Edit Data Kriteria</h6>
    </div>
